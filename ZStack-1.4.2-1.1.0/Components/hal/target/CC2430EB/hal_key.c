             /**************************************************************************************************
    Filename:       hal_key.c
    Revised:        $Date: 2007-03-29 16:44:28 -0700 (Thu, 29 Mar 2007) $
    Revision:       $Revision: 13896 $
...
void HalKeyPoll (void)
{
  ...
  */
//#if defined ((HAL_KEY_SW_6_ENABLE) || (HAL_KEY_SW_5_ENABLE))
