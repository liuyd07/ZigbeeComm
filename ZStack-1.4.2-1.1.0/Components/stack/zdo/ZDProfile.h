 ...
 */
extern afStatus_t ZDP_NodeDescMsg( byte TransSeq, zAddrType_t *dstAddr,
      uint16 nwkAddr, NodeDescriptorFormat_t *pNodeDesc, byte SecurityEnable );

/*
 * ZDP_PowerDescMsg - Send a Node Power Descriptor message.
 */
extern afStatus_t ZDP_PowerDescMsg( byte TransSeq, zAddrType_t *dstAddr,
 ...
 */
extern afStatus_t ZDP_SimpleDescMsg( byte TransSeq, zAddrType_t *dstAddr,
                           byte Status, SimpleDescriptionFormat_t *pSimpleDesc,
                           uint16 clusterID, byte SecurityEnable );
