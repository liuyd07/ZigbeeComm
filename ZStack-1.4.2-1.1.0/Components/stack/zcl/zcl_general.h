...
/*********************************************************************
    ...
    Revised:        $Date: 2007-02-23 08:50:48 -0800 (Fri, 23 Feb 2007) $
    Revision:       $Revision: 13576 $

    Description:

       This file contains the ZCL General definitions.
...
/*********************************/
#define COMMAND_IDENTIFY_QUERY                           0x00
...
#define ATTRID_SCENES_LAST_CFG_BY                         0x0004
...
#define LEVEL_MOVE_STOP                                   0x00
#define LEVEL_MOVE_UP                                     0x01
#define LEVEL_MOVE_ON_AND_UP                              0x02
#define LEVEL_MOVE_DOWN                                   0x03
#define LEVEL_MOVE_DOWN_AND_OFF                           0x04

/*** Level Control Step (Mode) Command values ***/
#define LEVEL_STEP_UP                                     0x01
#define LEVEL_STEP_ON_AND_UP                              0x02
#define LEVEL_STEP_DOWN                                   0x03
#define LEVEL_STEP_DOWN_AND_OFF                           0x04
...
typedef void (*zclGCB_IdentifyRsp_t)( afAddrType_t *dstAddr, uint16 timeout );
...
typedef void (*zclGCB_LevelControlMoveToLevel_t)( uint8 level, uint16 transitionTime );
...
typedef void (*zclGCB_LevelControlStep_t)( uint8 stepMode, uint8 amount, uint16 transitionTime );
...
typedef void (*zclGCB_GroupRsp_t)( afAddrType_t *srcAddr, uint8 cmdID,
                                   uint8 status, uint8 grpCnt, uint16 *grpList,
                                   uint8 capacity, uint8 *grpName );
...
typedef uint8 (*zclGCB_SceneStoreReq_t)( afAddrType_t *srcAddr, zclGeneral_Scene_t *scene );
...
//   srcAddr - requestor's address
//   scene - pointer to the scene structure
typedef void (*zclGCB_SceneRecallReq_t)( afAddrType_t *srcAddr, zclGeneral_Scene_t *scene );
...
typedef void (*zclGCB_SceneRsp_t)( afAddrType_t *srcAddr, uint8 cmdID, uint8 status, uint8 sceneCnt,
                                   uint8 *sceneList, uint8 capacity, zclGeneral_Scene_t *scene );
...
typedef void (*zclGCB_Alarm_t)( afAddrType_t *srcAddr, uint8 cmdID, uint8 status,
                                uint8 alarmCode, uint16 clusterID, uint32 timeStamp );
...
typedef void (*zclGCB_Location_t)( afAddrType_t *srcAddr, uint8 cmdID,
                                   zclLocationAbsolute_t *absLoc, zclLocationGetData_t *loc,
                                   zclLocationDevCfg_t *devCfg, uint8 *ieeeAddr, uint8 seqNum );
...
typedef void (*zclGCB_LocationRsp_t)( afAddrType_t *srcAddr, uint8 cmdID, zclLocationDataRsp_t *locRsp,
                                      zclLocationDevCfgRsp_t *devCfgRsp, uint8 locationType );
...
typedef struct
{
  ...
  zclGCB_IdentifyRsp_t              pfnIdentifyRsp;               // Identify Response command
 ...
 *  Use like:
 *      ZStatus_t zclGeneral_SendBasicResetFactoryDefaults( uint16 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendBasicResetFactoryDefaults(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_BASIC, TRUE, COMMAND_BASIC_RESET_FACT_DEFAULT, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )
#endif // ZCL_BASIC
 ...
 *  Use like:
 *      ZStatus_t zclGeneral_SendIdentifyQuery( uint8 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendIdentifyQuery(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_IDENTIFY, TRUE, COMMAND_IDENTIFY_QUERY, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )
#endif // ZCL_IDENTIFY
 ...
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupAdd( uint8 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 *groupName, uint8 seqNum );
 */
#define zclGeneral_SendGroupAdd(a,b,c,d,e) zclGeneral_SendAddGroupRequest( (a), (b), COMMAND_GROUP_ADD, (c), (d), (e) )

/*
 *  Send a Group View Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupView( uint8 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 seqNum );
 */
#define zclGeneral_SendGroupView(a,b,c,d) zclGeneral_SendGroupRequest( (a), (b), COMMAND_GROUP_VIEW, (c), (d) )

/*
 *  Send a Group Get Membership Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupGetMembership( uint8 srcEP, afAddrType_t *dstAddr, uint8 grpCnt, uint16 *grpList, uint8 seqNum );
 */
#define  zclGeneral_SendGroupGetMembership(a,b,c,d,e) zclGeneral_SendGroupGetMembershipRequest( (a), (b), COMMAND_GROUP_GET_MEMBERSHIP, FALSE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), (d), (e) )

/*
 *  Send a Group Remove Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupRemove( uint8 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 seqNum );
 */
#define zclGeneral_SendGroupRemove(a,b,c,d) zclGeneral_SendGroupRequest( (a), (b), COMMAND_GROUP_REMOVE, (c), (d) )

/*
 *  Send a Group Remove ALL Command - COMMAND_GROUP_REMOVE_ALL
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupRemoveAll( uint16 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendGroupRemoveAll(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_GROUPS, TRUE, COMMAND_GROUP_REMOVE_ALL, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )

/*
 *  Send a Group Add If Identifying Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupAddIfIdentifying( uint8 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 *groupName, uint8 seqNum );
 */
#define zclGeneral_SendGroupAddIfIdentifying(a,b,c,d,e) zclGeneral_SendAddGroupRequest( (a), (b), COMMAND_GROUP_ADD_IF_IDENTIFYING, (c), (d), (e) )

/*
 *  Send a Group Add Response Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupAddResponse( uint8 srcEP, afAddrType_t *dstAddr, uint8 status, uint16 groupID, uint8 seqNum );
 */
#define zclGeneral_SendGroupAddResponse(a,b,c,d,e) zclGeneral_SendGroupResponse( (a), (b), COMMAND_GROUP_ADD_RSP, (c), (d), (e) )

/*
 *  Send a Group Get Membership Response Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupGetMembershipResponse( uint8 srcEP, afAddrType_t *dstAddr, uint8 capacity, uint8 grpCnt, uint16 *grpList, uint8 seqNum );
 */
#define  zclGeneral_SendGroupGetMembershipResponse(a,b,c,d,e,f) zclGeneral_SendGroupGetMembershipRequest( (a), (b), COMMAND_GROUP_GET_MEMBERSHIP_RSP, TRUE, ZCL_FRAME_SERVER_CLIENT_DIR, (c), (d), (e), (f) )

/*
 *  Send a Group Remove Response Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendGroupRemoveResponse( uint8 srcEP, afAddrType_t *dstAddr, uint8 status, uint16 groupID, uint8 seqNum );
 */
#define zclGeneral_SendGroupRemoveResponse(a,b,c,d,e) zclGeneral_SendGroupResponse( (a), (b), COMMAND_GROUP_REMOVE_RSP, (c), (d), (e) )
#endif // ZCL_GROUPS
 ...
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneView( uint8 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 sceneID, uint8 seqNum );
 */
#define zclGeneral_SendSceneView(a,b,c,d,e) zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_VIEW, (c), (d), (e) )

/*
 *  Send a Scene Remove Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneRemove( uint8 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 sceneID, uint8 seqNum );
 */
#define zclGeneral_SendSceneRemove(a,b,c,d,e) zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_REMOVE, (c), (d), (e) )

/*
 *  Send a Scene Store Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneStore( uint8 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 sceneID,  uint8 seqNum );
 */
#define zclGeneral_SendSceneStore(a,b,c,d,e) zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_STORE, (c), (d), (e) )

/*
 *  Send a Scene Recall Command
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneRecall( uint8 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 sceneID, uint8 seqNum );
 */
#define zclGeneral_SendSceneRecall(a,b,c,d,e) zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_RECALL, (c), (d), (e) )

/*
 *  Send a Scene Remove ALL Command - COMMAND_SCENE_REMOVE_ALL
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneRemoveAll( uint16 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 seqNum );
 */
#define zclGeneral_SendSceneRemoveAll(a,b,c,d) zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_REMOVE_ALL, (c), 0, (d) )

/*
 *  Send a Scene Get Membership Command - COMMAND_SCENE_GET_MEMBERSHIPSHIP
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneGetMembership( uint16 srcEP, afAddrType_t *dstAddr, uint16 groupID, uint8 seqNum );
 */
#define zclGeneral_SendSceneGetMembership(a,b,c,d) zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_GET_MEMBERSHIP, (c), 0, (d) )

/*
 *  Send a Scene Remove ALL Response Command - COMMAND_SCENE_ADD_RSP
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneAddResponse( uint16 srcEP, afAddrType_t *dstAddr, uint8 status, uint16 groupID, uint8 sceneID, uint8 seqNum );
 */
#define zclGeneral_SendSceneAddResponse(a,b,c,d,e,f) zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_ADD_RSP, (c), (d), (e), (f) )

/*
 *  Send a Scene Remove Response Command - COMMAND_SCENE_REMOVE_RSP
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneRemoveResponse( uint16 srcEP, afAddrType_t *dstAddr, uint8 status, uint16 groupID, uint8 sceneID, uint8 seqNum );
 */
#define zclGeneral_SendSceneRemoveResponse(a,b,c,d,e,f) zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_REMOVE_RSP, (c), (d), (e), (f) )

/*
 *  Send a Scene Remove All Response Command - COMMAND_SCENE_REMOVE_ALL_RSP
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneRemoveAllResponse( uint16 srcEP, afAddrType_t *dstAddr, uint8 status, uint16 groupID, uint8 seqNum );
 */
#define zclGeneral_SendSceneRemoveAllResponse(a,b,c,d,e) zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_REMOVE_ALL_RSP, (c), (d), 0, (e) )

/*
 *  Send a Scene Remove ALL Response Command - COMMAND_SCENE_STORE_RSP
 *  Use like:
 *      ZStatus_t zclGeneral_SendSceneStoreResponse( uint16 srcEP, afAddrType_t *dstAddr, uint8 status, uint16 groupID, uint8 sceneID, uint8 seqNum );
 */
#define zclGeneral_SendSceneStoreResponse(a,b,c,d,e,f) zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_STORE_RSP, (c), (d), (e), (f) )
#endif // ZCL_SCENES
 ...
 *  Use like:
 *      ZStatus_t zclGeneral_SendOnOff_CmdOff( uint16 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendOnOff_CmdOff(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_ON_OFF, TRUE, COMMAND_OFF, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )

/*
 *  Send an On Off Command - COMMAND_ONOFF_ON
 *  Use like:
 *      ZStatus_t zclGeneral_SendOnOff_CmdOn( uint16 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendOnOff_CmdOn(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_ON_OFF, TRUE, COMMAND_ON, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )

/*
 *  Send an On Off Command - COMMAND_ONOFF_TOGGLE
 *  Use like:
 *      ZStatus_t zclGeneral_SendOnOff_CmdToggle( uint16 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendOnOff_CmdToggle(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_ON_OFF, TRUE, COMMAND_TOGGLE, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )
#endif // ZCL_ON_OFF
 ...
 *  Use like:
 *      ZStatus_t zclGeneral_SendAlarmReset( uint16 srcEP, afAddrType_t *dstAddr, uint8 alarmCode, uint16 clusterID, uint8 seqNum );
 */
#define zclGeneral_SendAlarmReset(a,b,c,d,e) zclGeneral_SendAlarmRequest( (a), (b), COMMAND_ALARMS_RESET, (c), (d), (e) )

/*
 *  Send an Alarm Reset ALL Command - COMMAND_ALARMS_RESET_ALL
 *  Use like:
 *      ZStatus_t zclGeneral_SendAlarmResetAll( uint16 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendAlarmResetAll(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_ALARMS, TRUE, COMMAND_ALARMS_RESET_ALL, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )


/*
 *  Send an Alarm Get Command - COMMAND_ALARMS_GET
 *  Use like:
 *      ZStatus_t zclGeneral_SendAlarmGet uint16 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendAlarmGet(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_ALARMS, TRUE, COMMAND_ALARMS_GET, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )

/*
 *  Send an Alarm Reset Log Command - COMMAND_ALARMS_RESET_LOG
 *  Use like:
 *      ZStatus_t zclGeneral_SendAlarmResetLog( uint16 srcEP, afAddrType_t *dstAddr, uint8 seqNum );
 */
#define zclGeneral_SendAlarmResetLog(a,b,c) zcl_SendCommand( (a), (b), ZCL_GEN_LOGICAL_CLUSTER_ID_ALARMS, TRUE, COMMAND_ALARMS_RESET_LOG, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), 0, NULL )
 ...
 *  Use like:
 *      ZStatus_t zclGeneral_SendLocationDataResponse( uint16 srcEP, afAddrType_t *dstAddr, zclLocationDataRsp_t *locData, uint8 seqNum );
 */
#define zclGeneral_SendLocationDataResponse(a,b,c,d) zclGeneral_SendLocationData( (a), (b), COMMAND_LOCATION_DATA_RSP, ((c)->status), (&((c)->data)), (d) )
 ...
 *  Use like:
 *      ZStatus_t zclGeneral_SendRSSIPing( uint16 srcEP, afAddrType_t *dstAddr, uint8 locationType, uint8 seqNum );
 */
#define zclGeneral_SendRSSIPing(a,b,c,d) zcl_SendCommand( (a), (b), ZCL_GENERAL_LOGICAL_CLUSTER_LOCATION, TRUE, COMMAND_LOCATION_RSSI_PING, TRUE, ZCL_FRAME_SERVER_CLIENT_DIR, 0, (d), 1, (c) )
#endif // ZCL_LOCATION
...
/*
 * Call to send out a Level Control - Move to Level Command
 *      level - what level to move to
 *      transitionTime - how long to take to get to the level (in seconds).
 */
extern ZStatus_t zclGeneral_SendLevelControlMoveToLevel( uint8 srcEP, afAddrType_t *dstAddr,
                                               uint8 level, uint16 transTime, uint8 seqNum );

/*
 * Call to send out a Level Control - Move
 *      moveMode - LEVEL_MOVE_STOP,
 *                 LEVEL_MOVE_UP,
 ...
 */
extern ZStatus_t zclGeneral_SendLevelControlMove( uint8 srcEP, afAddrType_t *dstAddr,
                                           uint8 moveMode, uint8 rate, uint8 seqNum );

/*
 * Call to send out a Level Control - Step
 *      stepMode - LEVEL_STEP_UP,
 ...
 */
extern ZStatus_t zclGeneral_SendLevelControlStep( uint8 srcEP, afAddrType_t *dstAddr,
                       uint8 stepMode, uint8 amount, uint16 transTime, uint8 seqNum );
...
extern ZStatus_t zclGeneral_SendGroupResponse( uint8 srcEP, afAddrType_t *dstAddr,
                           uint8 cmd, uint8 status, uint16 groupID, uint8 seqNum );
...
extern ZStatus_t zclGeneral_SendSceneRequest( uint8 srcEP, afAddrType_t *dstAddr,
                         uint8 cmd, uint16 groupID, uint8 sceneID, uint8 seqNum );
...
extern ZStatus_t zclGeneral_SendSceneViewResponse( uint8 srcEP, afAddrType_t *dstAddr,
                               uint8 status, zclGeneral_Scene_t *scene, uint8 seqNum );
...
extern ZStatus_t zclGeneral_SendSceneGetMembershipResponse( uint8 srcEP, afAddrType_t *dstAddr,
                              uint8 sceneStatus, uint8 capacity, uint8 sceneCnt,
