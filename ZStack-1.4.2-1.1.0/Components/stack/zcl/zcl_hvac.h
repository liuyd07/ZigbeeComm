...
/*********************************************************************
    ...
    Description:
      ...
      Zigbee HVAC Cluster Library

      This file contains the ZCL HVAC definitions.
...
typedef void (*zclHVAC_PlaceHolder_t)( void );
...
typedef void (*zclHVAC_SetpointRaiseLower_t)( uint8 mode, uint8 amount );
