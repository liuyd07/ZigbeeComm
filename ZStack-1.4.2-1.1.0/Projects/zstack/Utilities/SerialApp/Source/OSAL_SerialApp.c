/*********************************************************************
    ...
    Revised:        $Date: 2007-02-23 10:36:23 -0800 (Fri, 23 Feb 2007) $
    Revision:       $Revision: 13580 $
...
void osalAddTasks( void )
{
  ...
  /*
     This task must be loaded first because Hal_Init() initialize
  ...
  */
  ...
  osalTaskAdd( SerialApp_Init, SerialApp_ProcessEvent, OSAL_TASK_PRIORITY_LOW );
}
